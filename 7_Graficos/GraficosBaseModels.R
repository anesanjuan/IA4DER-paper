...
pdf("modelos_base_prediccion_media.pdf", width = 10, height = 6)
...
pdf("modelos_base_prediccion_mediana.pdf", width = 10, height = 6)
...
nuevos_fforma <- fread("modelosNuevosFFORMA_MAPE.csv")
