...
fwrite(lm_df, "REDUCIDO_DIA/combined_lm.csv")
rf_df <- combinar_archivos_en_df(model_files[[2]])
fwrite(rf_df, "REDUCIDO_DIA/combined_rf.csv")
xgboost_df <- combinar_archivos_en_df(model_files[[3]])
fwrite(xgboost_df, "REDUCIDO_DIA/combined_xgboost.csv")
knn_df <- combinar_archivos_en_df(model_files[[4]])
fwrite(knn_df, "REDUCIDO_DIA/combined_knn.csv")
...
fwrite(combinedPreds, "REDUCIDO_DIA/combinedPreds.csv")

#LEER ARCHIVOS PARA FFORMA

feats <- fread("preds_MAPE_RMSE.csv")
combinedPreds <- fread("REDUCIDO_DIA/combinedPreds.csv")
feats$ID <- feats$id
...
fwrite(pb, "REDUCIDO_DIA/FFORMA.csv")
...
fwrite(pb, "REDUCIDO_DIA/FFORMA_MAPE.csv")
